...
select Phone as "supplier phone number" from suppliers
where SupplierID = 11
...
-- (Stretch) Find a query to discover how many different cities
-- are stored in the Customers table. Repeats should not be double counted
